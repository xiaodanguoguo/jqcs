...
public final class MimeTypeUtils {
	static final Map<String, String> MIME_TYPE_MAP = new HashMap<String, String>();
	static {
	...
	public static String getContentType(String fileExtName) {
		String trimExtName = StringUtils.isBlank(fileExtName) ? null : StringUtils.trimToNull(fileExtName);
		String lowerExtKey = StringUtils.isBlank(trimExtName) ? null : trimExtName.toLowerCase();
		String contentType = StringUtils.isBlank(lowerExtKey) ? null : MIME_TYPE_MAP.get(lowerExtKey);
