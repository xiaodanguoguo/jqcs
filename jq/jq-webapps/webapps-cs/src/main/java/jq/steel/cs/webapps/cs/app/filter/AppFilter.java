...
public class AppFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        String[] str = new String[]{"/app/file/uploads","/app/address/getList","/app/userRegistration/getSale","/app/login","/app/logout","/app/register","/app/version/getNewVersion","/millSheetDetail/qrCode"};
        EXCLUDE_URL = str;
    }
